 ...
 *  - should handle ActionType.SET_IS_PRELOAD action
 *  - should handle unknown actions
 *  - should handle ActionType.SET_IS_PRELOAD with different initial state
 *  - should handle ActionType.SET_IS_PRELOAD with missing payload
 *
 */
