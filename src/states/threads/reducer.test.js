 ...
 *  - should handle ActionType.RECEIVE_THREADS action
 *  - should handle ActionType.TOGGLE_VOTE_THREAD action - Upvote
 *  - should handle ActionType.TOGGLE_VOTE_THREAD action - Downvote
 *  - should handle ActionType.REVERT_VOTE_THREAD action - Previous Vote Type 1
 *  - should handle ActionType.REVERT_VOTE_THREAD action - Previous Vote Type -1
 *  - should handle ActionType.REVERT_VOTE_THREAD action - Previous Vote Type 0
 *  - should handle unknown actions
 *  - should handle ActionType.TOGGLE_VOTE_THREAD action - Non-existent Thread ID
 *  - should handle ActionType.REVERT_VOTE_THREAD action - Non-existent Thread ID
 *  - should handle ActionType.TOGGLE_VOTE_THREAD action - Empty upVotesBy and downVotesBy
 *  - should handle ActionType.REVERT_VOTE_THREAD action - User Not in upVotesBy or downVotesBy
