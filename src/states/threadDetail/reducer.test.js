 ...
 *  - should handle ADD_THREAD_COMMENT action
 *  - should handle TOGGLE_VOTE_THREAD_DETAIL action
 *  - should handle REVERT_VOTE_THREAD_DETAIL action with previousVoteType 1
 *  - should handle REVERT_VOTE_THREAD_DETAIL action with previousVoteType -1
 *  - should handle REVERT_VOTE_THREAD_DETAIL action with previousVoteType 0
 *  - should handle REVERT_VOTE_COMMENT action with previousVoteType 1
 *  - should handle REVERT_VOTE_COMMENT action with previousVoteType -1
 *  - should handle REVERT_VOTE_COMMENT action with previousVoteType 0
